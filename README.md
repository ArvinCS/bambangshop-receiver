...
RwLock<> allows us to read data concurrently and one write operation at a time. In the other hand, Mutex<> doesn't support read operations concurrently. In this tutorial, we read Vec of Notifications a lot of times. Thus, it is more suitable to use RwLock<> instead of Mutex<>
